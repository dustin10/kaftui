...
> are mainly used to for code reviews, bug hunting and generating documentation. Occasionally, AI
> tools may be used to generate small snippets of code for non-core features or to assist with
> refactoring.
